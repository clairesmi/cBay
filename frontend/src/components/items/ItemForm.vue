<template>
  <div id="item-form" class="h-screen flex flex-col items-center bg-red-200">
    ...
    <div class="form-wrapper h-full w-full flex justify-center bg-red-200">
      <form
        class="flex flex-col w-2/4 justify-around pt-10 pb-10 pr-40 pl-40 text-gray-900 bg-red-200"
      >
        <label>Name</label>
        <input
          type="text"
        ...
        <div>
          ...
          ><code>{{ value ? value.name: null }}</code></pre>
        </div>
        <button
          class="form-button mt-2 bg-red-200"
