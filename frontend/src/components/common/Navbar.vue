<template>
  <div id='navbar' class="text-gray-800 bg-red-200">
      <nav toggleable="sm" type="light" variant="light" class="flex flex-row justify-between pl-5 pr-5 pt-2">
